...
- **Verified commands (Sessions 17-22, 2026-08-02):**
  - `source .venv/bin/activate && pytest -q` — 309 passed (Session 22)
  - `source .venv/bin/activate && ruff check .` — All checks passed (Session 22)
  - `source .venv/bin/activate && mypy src/portallens` — Success: no issues found in 46 source files (Session 22)
